        ...
        <div className="big-box">
          <div className="row">
            <div className="text first-text">
              ...
              <span>survey in the shortest possible time</span>{" "}
              <span>and send it to your friends</span>
            </div>
          ...
          <div className="row">
            <div className="text first-text">
              <span className="bold">Quick and easy access!</span>
              <span> Due to easy access and simple structure,</span>
              <span> you can easily create your </span>{" "}
              <span>in the shortest time</span>
            </div>
          ...
          <div className="row margin-buttom">
            <div className="text first-text">
              <span className="bold">The highest speed!</span>
              <span> You can make your own measurement</span>
              <span> in the fastest time with the</span>{" "}
